...
def test_logic_bool_conversions() -> None:
...
def test_logic_str_conversions() -> None:
...
def test_logic_index_cast() -> None:
...
def test_logic_int_conversions() -> None:
